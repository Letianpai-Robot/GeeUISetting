...
class SleepSnoringFragment : BaseSecondFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tips?.setText(getString(R.string.sleep_snoring_tips))
    ...
    private fun updateUI() {
        activity?.runOnUiThread {
            switchbtn?.isChecked = sleepConfig?.sleepSoundModeSwitch == 1
            ...
            switchbtn?.setOnCheckedChangeListener { buttonView, isChecked ->
                ...
                sleepConfig?.sleepSoundModeSwitch = if (isChecked) 1 else 0
                updateData()
            }
        }
    }
